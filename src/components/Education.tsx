                ...
                <div className={`lg:w-1/2 ${isLeft ? 'lg:pr-12' : 'lg:pl-12 lg:ml-auto'}`}>
                  <Card3D intensity={10}>
                    <div className={`group relative ${isLeft ? 'lg:-mr-6' : 'lg:-ml-6'}`}>
                      ...
                      <Card className={`bg-gradient-to-br ${edu.bgGradient} dark:from-slate-800/50 dark:via-slate-700/50 dark:to-slate-800/50 backdrop-blur-lg border-2 border-white/20 shadow-2xl hover:shadow-3xl transition-all duration-500 overflow-hidden relative`}>
                      {/* Floating icon */}
